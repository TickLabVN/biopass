...
class FaceAntiSpoofing {
 public:
  FaceAntiSpoofing(
      ...
      const std::string& ckpt, const cv::Size& imgsz = {128, 128}, const bool& cuda = false,
...
class FaceAntiSpoofing2 {
 public:
  FaceAntiSpoofing2(const std::string& ckpt1, const std::string& ckpt2,
                    const cv::Size& imgsz = {80, 80}, const bool& cuda = false,
