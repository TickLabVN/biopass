...
Facepass is split into two primary components to ensure clean separation between UI logic and security-critical modules:
...
- **`config/`**: Shared library for managing Facepass settings.
